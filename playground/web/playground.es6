...
const { Action, Image, Subtitle, TextBlock, Title } = PanelsBlocks;
const actionStyle = {
  base: {
    marginTop: 25,
  ...
  render() {
    return (
      <div style={{width: 360}}>
        ...
        <Action href='http://UXtemple.com' style={actionStyle.base} activeStyle={actionStyle.active}>
          stuff
          <Icon />
        </Action>
        <Action href='http://UXtemple.com' title='UXtemple' style={actionStyle.base} activeStyle={actionStyle.active} />
        <Action href='http://usepanels.com' title='use panels' style={actionStyle.base} activeStyle={actionStyle.active} />
